...
configuration.add_argument('-b', '--bad-expressions', dest='bad_expressions', action='store', nargs='+',
                           help="specifies bad expressions - if the DumpsterDiver find such expression in a file, "
                                "then this file won't be analyzed. Multiple bad expressions should be separated by "
                                "space. ")
try:
